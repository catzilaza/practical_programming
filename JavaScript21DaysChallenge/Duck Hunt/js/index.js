(()=> {
   ...
   function setupDuckElement(duck) {
       ...
       duckElem.style.backgroundImage = "url('./images/duck/black/left/left-1.png')";
   ...
   function moveDuck(duckElem, duck) {
       ...
       const outOgBoundX = duck.x < 0 || duck.x > window.innerWidth;
       const outOgBoundY = duck.y < 0 || duck.y > window.innerHeight;
   ...
   function getDuckBackgroundImage(duck, duckElem) {
       ...
       duckElem.style.backgroundImage.indexOf('1') !== -1 ? 
       `url(./images/duck/black/right/${direction}-2.png)`:
       `url(./images/duck/black/left/${direction}-1.png)`;
