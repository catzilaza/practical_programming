( ()=> {
    ...
    */
    ...
    //  2.1 Invoker object
    /*
    const ariya = {name: 'Ariya', printName: printName};
    const duan = {name: 'Duan', printName};
    ...
    */
    ...
    function Person(name, nationality, city) {
        ...
        const printAriya = printName.bind(this);
        printAriya(this.nationality, this.city);
    }

    const ariya = new Person('Ariya', 'Thai', 'Bangkok');
